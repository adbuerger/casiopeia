...
# casiopeia documentation build configuration file, created by
...
project = u'casiopeia'
copyright = u'Adrian Buerger 2014-2016, Jesus Lago Garcia 2014-2015'
...
htmlhelp_basename = 'casiopeiadoc'
...
# latex_documents = [
#   ('index', 'casiopeia.tex', u'casiopeia Documentation',
...
man_pages = [
    ('index', 'casiopeia', u'casiopeia Documentation',
     [u'Adrian Buerger'], 1)
]
...
# texinfo_documents = [
#   ('index', 'casiopeia', u'casiopeia Documentation',
#    u'Adrian Buerger', 'casiopeia', 'One line description of project.',
#    'Miscellaneous'),
# ]
